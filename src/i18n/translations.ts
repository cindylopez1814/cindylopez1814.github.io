...
export const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    'cartola-next-sub': 'Explora Isla Nativa Travel: un marketplace diseñado end-to-end usando IA como colaborador de ejecución.',
    ...
    'isla-next-sub': 'Explora Lirmi Familia: rediseño end-to-end basado en investigación con usuarios reales.',
  ...
  pt: {
    ...
    'cartola-next-sub': 'Explore Isla Nativa Travel: um marketplace projetado end-to-end usando IA como colaborador de execução.',
    'cartola-btn-back': '← Voltar ao portfólio',
    'cartola-btn-next': 'Ver caso Isla Nativa →',
    'isla-next-label': 'Próximo caso',
    'isla-next-title1': 'Research profundo,',
    'isla-next-title2': 'impacto mensurável',
    'isla-next-sub': 'Explore Lirmi Familia: redesign end-to-end baseado em pesquisa com usuários reais.',
  ...
  en: {
    ...
    'cartola-next-sub': 'Explore Isla Nativa Travel: a marketplace designed end-to-end using AI as execution collaborator.',
    ...
    'isla-next-sub': 'Explore Lirmi Familia: end-to-end redesign grounded in research with real users.',
